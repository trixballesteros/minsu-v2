...
@section('content')
    ...
    <div class="about_bg">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1>Office of the Vice President for Research, Extension and Development</h1>
                </div>
            </div>
                ...
                <div class="col-md-9" style="padding-right: 40px">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="background-color: #0b5421" class="card-header">
                                    <h4 style="color: white">Message of the Vice President for Research, Extension and Development</h4>
                                </div>
                                <div class="card-text">
                                    <div class="row p-4">
                                        <div class="col-md-4">
                                            <img style="border: 2px solid #0b5421;width: 100%;object-fit: cover"
                                                 src="/template/images/employee/MinsuVPRED.jpg" alt="">
                                        </div>
                                        <div class="col-md-8">
                                            ...
                                            <p>Vice President for Research, Extension and Development </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style="margin-top: 50px" class="row">
                        <div style="width: 100%" class="card">
                            <div class="card-body">
                                <div style="background-color: #0b5421" class="card-header">
                                    <h4 style="color: white">About the Vice President for Research, Extension and Development</h4>
                                </div>
