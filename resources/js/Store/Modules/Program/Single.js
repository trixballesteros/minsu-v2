...
const actions = {
    storeData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            axios.post(route('api.program.store'), params)
                .then(response => {
    ...
    updateData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            axios.post(route('api.program.update', state.item.id),params)
                .then(response => {
...
const mutations = {
    ...
    setCampus(state, value){
        state.item.campus = value
        state.formErrors.campus = null
    },
