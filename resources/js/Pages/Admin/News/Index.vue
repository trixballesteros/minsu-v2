			...
			<div class="content">
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 d-inline-block mb-0">News</h6>
						<nav
					...
					<div class="col-lg-6 col-5 text-right">
						...
						<form @submit.prevent="submit">
							<modal size="lg" v-model:show="modals.college">
								...
								<div class="text-left">
                                    ...
                                    <base-input label="Date" name= "date">
                                    <el-date-picker placeholder="Select date" value-format="YYYY-MM-DD" @update:modelValue="setDate({name:'date',value:$event})" v-model="item.date" size="large" />
                                    </base-input>
								</div>
					...
					>
						<div>
							...
							>
                                ...
                                <el-table-column key="Date" label="Date">
...
<script>
    ...
    import BaseInput from "../../../Argon/components/Inputs/BaseInput";
    ...
    export default {
		...
		computed: {
			...mapGetters("NewsIndex", [
				"tableData",
				"pagination",
				"tableColumns",
				"serverQuery",
			]),
			...mapGetters("NewsSingle", ["item", "formErrors"]),
		},
		unmounted: function () {
			this.resetNewsState();
			this.resetState();
		...
		methods: {
			...mapActions("NewsIndex", [
				"fetchData",
				"setServerQuery",
				"destroyData",
			]),
			...mapActions("NewsIndex", { resetNewsState: "resetState" }),
			...mapActions("NewsSingle", [
				"setTitle",
				"setDate",
				"setDescription",
				"setContent",
