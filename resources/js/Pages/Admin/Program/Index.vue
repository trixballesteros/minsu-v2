			...
			<div class="content">
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 d-inline-block mb-0">Programs</h6>
						<nav
						...
						<form @submit.prevent="submit">
							<modal v-model:show="modals.college">
								...
								<div class="text-left">
                                    ...
                                    <base-input  name="campus" label="Campus"
                                                 :error="formErrors.campus"
                                    >
                                        <el-select
                                            :model-value="item.campus"
                                            @update:model-value="setCampus($event)"
                                            clearable
                                            value-key="id"
                                    ...
                                    <base-input
                                        label="Code"
                                        name="code"
                                        placeholder="Enter  code (E.g. BSIT)"
									...
									<base-input
										label="Name"
										name="name"
										placeholder="Enter  name (E.g. Bachelor of Science in Information Technology)"
	...
	export default {
		...
		data() {
			return {
                ...
                campuses:[
                    {id: 1,code: 'MMC',name: 'Main Campus'},
                    {id: 2,code: 'MCC',name: 'Calapan Campus'},
                    {id: 3,code: 'MBC',name: 'Bongabong Campus'},
                ]
			};
		},
		computed: {
			...mapGetters("ProgramIndex", [
				"tableData",
				"pagination",
				"tableColumns",
				"serverQuery",
			]),
			...mapGetters("ProgramSingle", ["item", "formErrors"]),
		},
		unmounted: function () {
		...
		methods: {
			...
			...mapActions("ProgramIndex", { resetProgramState: "resetState" }),
			...mapActions("ProgramSingle", [
				"setName",
				"setCode",
				"setImage",
				"setCampus",
