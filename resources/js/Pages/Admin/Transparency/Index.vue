            ...
            <div class="content">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 d-inline-block mb-0">Transparency</h6>
                        <nav
                        ...
                        <div class="text-left">
                            ...
                            >
                                <file-input
                                    ...
                                    clearable
                                    ref="fileInput"
                                    @change="setTransparencyFile($event)"
                                />
                            </base-input>
                        </div>
...
export default {
    ...
    computed: {
        ...mapGetters("TransparencyIndex", [
            "tableData",
            "pagination",
            "tableColumns",
            "serverQuery",
        ]),
        ...mapGetters("TransparencySingle", ["item", "formErrors"]),
    },
    unmounted: function () {
    ...
    methods: {
        ...mapActions("TransparencyIndex", [
            "fetchData",
            "setServerQuery",
            "destroyData",
        ]),
        ...mapActions("TransparencyIndex", {resetTransparencyState: "resetState"}),
        ...mapActions("TransparencySingle", [
            "setName",
            "setTransparencyFile",
            "setParentId",
            "setItem",
